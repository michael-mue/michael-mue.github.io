const socialIcons = {
  ...
  >
    ...
    <path d="M12 3L2 9l10 6l10-6-10-6z" fill="currentColor"/>
    <path d="M2 17h20v4H2z" fill="currentColor"/>
  </svg>`,
  Facebook: `<svg
    xmlns="http://www.w3.org/2000/svg"
    class="icon-tabler"
  ...
  // TODO: add proper SVG for Bluesky
  Bluesky: `<svg
    xmlns="http://www.w3.org/2000/svg"
    class="icon-tabler"
    viewBox="0 0 24 24"
  ...
  >
    <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
    <path d="M9.75 16.5c0 0-5.5-3-5.5-7.5c0-2 2-2 3.5-1c1 .7 2.25 2.5 4.25 2.5s3.25-1.8 4.25-2.5c1.5-1 3.5-1 3.5 1c0 4.5-5.5 7.5-5.5 7.5l-1 1z" fill="currentColor"/>
  </svg>`,
};
